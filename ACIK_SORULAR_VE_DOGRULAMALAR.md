...
**Son güncelleme:** 3 Eylül 2026 — swipe toleransı focused CI PASS / ürün entegrasyonu açık
...
- `SWIPE_FALSE_POSITIVE_MISTAKES` — Kısa gesture iptali, exact kelimede tek trailing overshoot ve tek aktif pointer input katmanında commit `8610b01e...` / Draft PR #166 ile kodlandı; gerçek yanlış seçim cezası korunuyor. Güncel HEAD `7c0affbe...`; otomatik run `33688788065` analyze/test/diff **PASS**. Ürün entegrasyonu ve toplu Android kapısı açık.
