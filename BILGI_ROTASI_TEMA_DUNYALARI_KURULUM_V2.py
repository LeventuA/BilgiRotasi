...
# -*- coding: utf-8 -*-
"""
Bilgi Rotası — Gerçek Tahta Temaları + Ses Atmosferini Kaldırma (V2)
...
EXPECTED_HEADS = {
    "7d55704a9f58e0964e486f626d9a77172a021ead",
    "71054074c1bcd748e64a7a9e90c51bfeb4500a6a",
}
...
def main() -> None:
    ...
    try:
        ...
        # Başlangıçtan kalan başka staged dosyaları commit'e karıştırma.
        # Çalışma dosyaları korunur; yalnızca index temizlenir.
        run("git", "reset", "--quiet")
