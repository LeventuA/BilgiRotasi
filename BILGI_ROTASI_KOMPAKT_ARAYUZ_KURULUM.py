...
"""
    ...
    text = apply_segment(
        ...
        [
            ...
            ("borderRadius: BorderRadius.circular(23)", "borderRadius: BorderRadius.circular(19)", 1),
            ("padding: const EdgeInsets.all(16)", "padding: const EdgeInsets.all(13)", 1),
            ("BorderRadius.circular(23)", "BorderRadius.circular(19)", 1),
...
"""
    ...
    return apply_segment(
        ...
        [
            ...
            ("borderRadius: BorderRadius.circular(24)", "borderRadius: BorderRadius.circular(20)", 1),
            ("padding: const EdgeInsets.all(18)", "padding: const EdgeInsets.symmetric(horizontal: 14, vertical: 12)", 1),
            ("BorderRadius.circular(24)", "BorderRadius.circular(20)", 1),
