...
open_level 5 "$REPORT_DIR/01_SELECTOR_LOGCAT.txt" "$REPORT_DIR/02_B5_GEOMETRY_LOGCAT.txt"
play_b5_targets "$REPORT_DIR/02_B5_GEOMETRY_LOGCAT.txt"
wait_state 5 7 0 0
sleep 0.8
...
return_to_selector 5 "$REPORT_DIR/08_SELECTOR_AFTER_B5_REPLAY_LOGCAT.txt"
open_level 10 "$REPORT_DIR/08_SELECTOR_AFTER_B5_REPLAY_LOGCAT.txt" "$REPORT_DIR/09_B10_GEOMETRY_LOGCAT.txt"
play_b10_targets "$REPORT_DIR/09_B10_GEOMETRY_LOGCAT.txt"
wait_state 10 9 0 0
sleep 0.8
