...
void main() {
  group('AdMob gelir modeli', () {
    ...
    test('kalıcı Android manifesti AdMob test kimliğini taşır', () {
      final manifest =
      ...
      expect(
        mainSource,
        isNot(contains('unawaited(AdMonetizationService.initialize());')),
      );
    });
  });
}
