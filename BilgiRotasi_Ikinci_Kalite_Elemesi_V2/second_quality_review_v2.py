#!/usr/bin/env python3
"""Bilgi Rotası ikinci kalite elemesi V2.
...
# Kategoriler kalite nedeniyle küçülebilir; sabit kota uygulanmaz.
# Çok yüksek değerler yalnızca eski kontrol akışını devre dışı bırakır.
CATEGORY_CAPS = {i: 10000 for i in range(6)}

# Yalnızca tekrarlı soru ailelerine üst sınır uygulanır.
# Genel kategori ailelerinde sabit kota yoktur.
FAMILY_CAPS = {
    "capital": 15,
    "author": 60,
    "director": 35,
...
def main() -> int:
    ...
    print()
    print(f"İkinci eleme V2 uygulandı. Yeni soru sayısı: {len(reloaded)}")
